...
<script>
	    ...
	    var flds ="界中文,界名,門中文,門名,綱中文,綱名,目中文,目名,科中文,科名,數量,查詢,地圖";
		mygrid.setHeader(flds);
		mygrid.setInitWidths("55,55,75,75,70,70,70,80,100,135,55,45,45")
		mygrid.setColAlign("left,left,left,left,left,left,left,left,left,left,center,center,center");
		mygrid.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ed,ed,ro,ro,ro");
		mygrid.setColumnIds(flds);
		mygrid.setSkin("light");
		mygrid.setColSorting("str,str,str,str,str,str,str,str,str,str,int,str,str");
			...
			//mygrid.setOnLoadingStart(showLoading)
			       				//mygrid.splitAt(1);
            if (queryPair[0]!="D1"){
		    mygrid.loadXML("familygrid_gridget.php?un="+Date.parse(new Date()));
			}else{
		    mygrid.loadXML("familygrid_gridget.php?sc_mask=id&cr_mask=equal&fa_mask="+valuePair[0]);
			}
			showLoading();
	//============================================================================================
...
//============================================================================================
		...
		function setCounter(){
			...
			span.style.color = "";
			span.innerHTML = "<font class='mydefine5'>共 "+mygrid.getRowsNum()+" 科</font>";
		}
		...
		function reloadGrid(){
			...
			mygrid.clearAll();
			mygrid.loadXML("familygrid_gridget.php?sc_mask="+escape(sc_mask)+"&fa_mask="+escape(fa_mask)+"&cr_mask="+escape(cr_mask)+"&orderBy="+window.s_col+"&direction="+window.a_direction);
...
<table cellspacing="0" cellpadding="0" border="0">
	<tr valign="middle">
		<td width="190" align="center" valign="middle"></td>
		<td width="180" align="left" valign="middle"><div class="mydefine3">調查生物科別數量統計</div></td>
		<td width="10" align="center"></td>
		<td width="330" align="left" valign="middle">
        <select class="mydefine" id="pfield" >
        <option class="mydefine" value="kingdom_c">界中文</option>
        <option class="mydefine" value="kingdom">界名</option>
...
document.getElementById("pfield").value = "family";
