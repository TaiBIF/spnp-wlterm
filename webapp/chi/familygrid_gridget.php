...
include("../conn_clean.php");
 ...
 $sqlstr="SELECT * from view_wlfamily limit 0,1";    
...
function getDataFromDB($name_mask,$code_mask,$sort_by,$sort_dir,$qb,$qe){
		...
		$sql="SELECT * from view_wlfamily Where 1=1";
		if($sc_mask!='' && $fa_mask!='')
		...
		if($res){
			while($row=mysql_fetch_array($res,MYSQL_NUM)){
	               ...
	               print("<cell><![CDATA[<a href='recordgrid.php?family=". $row[10]."'><img border='0' src='../images/smallearth.gif' height='10'></a>]]></cell>");
	               print("<cell><![CDATA[<a href='locamap.php?pfield=family&pcr=equal&pvalue=". $row[10]."&ch=".phpescape($row[9])."'><img border='0' src='../images/smallearth.gif' height='10'></a>]]></cell>");				
				print("</row>");
				$posStart++;
			}
		}else{
