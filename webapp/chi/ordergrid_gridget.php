...
include("../conn_clean.php");
 ...
 $sqlstr="SELECT * from view_wlorder limit 0,1";    
...
function getDataFromDB($name_mask,$code_mask,$sort_by,$sort_dir,$qb,$qe){
		...
		$sql="SELECT * from view_wlorder Where 1=1";
		if($sc_mask!='' && $fa_mask!='')
		...
		if($res){
			while($row=mysql_fetch_array($res,MYSQL_NUM)){
	               ...
	               print("<cell><![CDATA[<a href='recordgrid.php?order=". $row[8]."'><img border='0' src='../images/smallearth.gif' height='10'></a>]]></cell>");
	               print("<cell><![CDATA[<a href='locamap.php?pfield=order&pcr=equal&pvalue=". $row[8]."&ch=".phpescape($row[7])."'><img border='0' src='../images/smallearth.gif' height='10'></a>]]></cell>");								
				   print("</row>");
				$posStart++;
			}
		}else{
