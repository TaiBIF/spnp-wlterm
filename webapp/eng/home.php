...
<table border="0" width="90%">
  <tr>
    <td valign="top"><p style="line-height: 150%"><font size="3">
      Introduction<br>
      </font><font size="2">The most important mission of Shei-Pa National Park is to conserve the natural resources, especially the Formosan landlocked salmon in the basin of Chichiawan Stream of the Wulin area. In order to understand the dynamics of the Formosan salmon, it is necessary to construct the trophic model and to examine the interactions between communities and environmental factors in the area. However, as many other basins, the Wulin area is exploited intensively for agricultural activities. Here, a collaborative project is proposed to ecologically monitor and integrate hydrodynamics, physical habitats, water quality, organic detritus, periphyton, riparian plants, terrestrial and aquatic insects, other invertebrates, amphibians, reptiles, fish and birds. The aims of this ecosystem-scale project are: 1. Using ecological models to understand the ecological processes of the salmons and the food webs; 2. To demonstrate the relationships between environmental factors and communities and between communities within the food webs; 3. To search the driving forces on the the ecological processes of the salmons and the food webs; 4. To trace the sources of nitrate in the water column and its relationships with human impacts; 5. To relate abundance and composition of commnities to physical habitats; 6. To examine effects of floods on the communities and habitats and their recovery; 7. To develope scientific database; 8. To suggest items for long-term ecological monitoring and policy for sustainable management in the future. </td>
    <td valign="top">
      <p style="line-height: 150%">
      　<p style="line-height: 150%">
      <img border="0" src="../images/map.jpg" width="400" height="400"><p style="line-height: 150%">
          <img border="0" src="../images/station.gif" width="300" height="399"></td>
  </tr>
</table>
<p>　</p>
<table border="0" width="90%">
  <tr>
    <td width="100%"><p style="line-height: 150%"><font size="3">
    Project 1</font><br><p style="line-height: 150%"><font size="2">
...
<br>【Keywords】the Formosan salmon, the Chichiawan stream, periphyton, detritus, trophic model, ECOPATH.
</font>
...
<table border="0" width="90%">
  <tr>
    <td width="100%"><p style="line-height: 150%"><font size="3">
    Project 7</font><br><p style="line-height: 150%"><font size="2">
    ...
    which is also important to the input of the river ecosystem.</td>
  </tr>
</table>
